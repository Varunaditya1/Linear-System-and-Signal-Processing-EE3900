...
\author{Varunaditya Singhal %<-this  stops a space
% <-this % stops a space
...
\end{align}
We know that $a_k$ = x(k-1)
    substiuating in the equation we get: 
\begin{align}
	\frac{1}{10}\sum_{k=1}^{\infty}\frac{x(k-1)}{10^{k-1}} =\frac{10}{89}
\end{align} 
...
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/Varunaditya1/Linear-System-and-Signal-Processing-EE3900/main/Pingala_Series/Codes/jee_2019.py
\end{lstlisting}
...
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/Varunaditya1/Linear-System-and-Signal-Processing-EE3900/main/Pingala_Series/Codes/stem.py
\end{lstlisting}
and run it using the command
\begin{lstlisting}
python3 stem.py
\end{lstlisting}
\begin{figure}[!htp]
    \includegraphics[width=\columnwidth]{Figures/2_1.png}
    \caption{Plot of $x(n)$}
    \label{fig:xn}
\end{figure}
...
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/Varunaditya1/Linear-System-and-Signal-Processing-EE3900/main/Pingala_Series/Codes/y_z.py
\end{lstlisting}
and run it using the command
\begin{lstlisting}
python3 y_z.py
